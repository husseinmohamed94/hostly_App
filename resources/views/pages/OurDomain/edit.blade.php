                       ...
                       @method('PUT')
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control"  name="name" value="{{$domain->name}}"  placeholder="Enter name">
                            </div>
                            @error('name')
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="details" value="{{$domain->details}}"   placeholder="Enter details">
                            </div>
                            @error('details')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="Duration">
                                    <option  value="{{$domain->Duration}}">{{$domain->Duration}}</option>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="price" value="{{$domain->price}}"  placeholder="price"

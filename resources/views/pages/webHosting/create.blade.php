    ...
    <div class="row justify-content-center">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{route('webhosting.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control"  name="unmeted" value="{{old('unmeted')}}"  placeholder="Enter unmeted">
                        </div>
                        @error('unmeted')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control"  name="storage" value="{{old('storage')}}"  placeholder="Enter storage">
                        </div>
                        @error('storage')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control"  name="support" value="{{old('support')}}"  placeholder="Enter support">
                        </div>
                        @error('support')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group col-md-3">
                           <label for="exampleInputTilte"> domain</label>
                            <input type="text" class="form-control" name="domain" value="{{old('domain')}}"  placeholder="Enter name domain">
                            </div>
                        @error('domain')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group col-md-3">
                           <label for="exampleInputTilte"> builder</label>
                             <input type="text" class="form-control" name="builder" value="{{old('builder')}}"  placeholder="builder">
                                 </div>
                        @error('builder')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group col-md-3">
                           <label for="exampleInputTilte"> sale</label>
                             <input type="text" class="form-control" name="Discount" value="{{old('Discount')}}"  placeholder="sale"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                 </div>
                        @error('sale')
                        <div class="alert alert-danger">{{ $message }}</div>

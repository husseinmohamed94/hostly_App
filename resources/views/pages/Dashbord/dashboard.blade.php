                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">HOSTLY APP  </h2>
                            <p class="pageheader-text">hostly app</p>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0">hosting Name</th>
                                          ...
                                          <tr>
                                            ...
                                            <td><span class="badge-dot badge-brand mr-1"></span>{{$order->InvoiceStatus}} </td>
                                        </tr>
                                          @endforeach
